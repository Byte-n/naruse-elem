...
const firstTemStyle = { width: '750rpx', height: '750rpx', background: '#FFF', display: 'flex', justifyContent: 'center', alignItems: 'center' };
const firstTemImgStyle = { width: '700rpx', height: '700rpx' };
const secondTemStyle = { position: 'relative' };
const secondTemImgStyle = { width: '750rpx', height: '2025rpx' };
const orderBtnStyle = { width: '750rpx', height: '124rpx', position: 'absolute', top: '20rpx' };
...
const mainBackgroundImg = 'http://q.aiyongtech.com/ad/images/bEFMUEp3WTdSMlROaW1uTkI2UE5BdTRfNzUwXzE5NTU=_1647512219465.png';
