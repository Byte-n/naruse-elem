        ...
        return (
            <view style={{ ...tradePcOrderTem,...(animation ? dialogBox : {}) }}>
                <view style={{ position:'relative'}}>
                    ...
                    <text style={{ ...buyBtnStyle, bottom: '335rpx', }} onClick={() => {jumpUrl('#/autoEvaluation','自动评价')}}/>
                    <text style={{ ...buyBtnStyle, bottom: '190rpx', }} onClick={() => {jumpUrl('#/refuseNegativeComment','差评拦截')}}/>
                    <text style={{ ...buyBtnStyle, bottom: '40rpx',}} onClick={() => {jumpUrl('#/tradeManagement','核对地址')}}/>
                </view>
                <view>
