...
import style from '../confirmBuyedDialog/index.css';
 ...
 */
export default class PayFailDialog extends Component {
    constructor () {
        super();
    ...
    render () {
        ...
        return (
            <view style={{ ...style.warpStyle, zIndex: 910 }}>
                <view style={{ ...style.dialogBox, ...(animation ? style.dialogBoxDown : {}), height: '750rpx', width: '750rpx' }}>
                    <view style={{
                        ...style.dialogHeader,
                        height: '200rpx',
                        ...
                        <view style={{
                            ...
                            <image src={'//q.aiyongtech.com/trade/web/img/payDialogCloseIcon.png'} />
                            <text style={style2.redTitle}>续费失败！</text>
                        </view>
                    </view>
                    <view style={{ ...style.dialogContent, padding: '20rpx 60rpx' }}>
                    ...
                    <view style={style.dialogBottom}>
                        <button
                            onClick={() => navigateToWebPage({ url: reBuyLink })}
