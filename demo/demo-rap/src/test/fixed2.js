...
class Test extends NaruseComponent {
    ...
    render () {
        ...
        } },this.state.qwer,'笑死', naruseCreateElement('view', { style: { position: 'fixed' ,fontSize: '50rpx', color: 'green', zIndex: 124, backgroundColor: 'red'  }, onClick: () => {
            console.log('被店家啦')
        } }, this.state.qwer, 'qwer')));
    }
}
