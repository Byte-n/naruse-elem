...
var _a$1;
var model = (_a$1 = navigator.userAgent.match(/\((.*?)\)/)) === null || _a$1 === void 0 ? void 0 : _a$1[1];
...
var showToast = function (options) {
    var err;
    if (err = exceptType(options, 'object', 'showToast'))
        return err;
    var title = options.title, duration = options.duration, success = options.success, fail = options.fail, complete = options.complete;
...
var hideToast = function (options) {
    var err;
    if (err = exceptType(options, 'object', 'hideToast'))
        return err;
...
var _config = {
    ...
    hotImport: function () {
        logger$1.error('未初始化热更新导入，无法更新组件默认为空');
