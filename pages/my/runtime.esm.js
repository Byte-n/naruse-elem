...
let document$2;
if (process.env.TARO_ENV !== 'h5') {
    hooks$3 = container.get(SERVICE_IDENTIFIER.Hooks);
    getElement = container.get(SERVICE_IDENTIFIER.TaroElementFactory);
    document$2 = getElement(ElementNames.Document)();
}
...
class TaroEvent {
    ...
    get target() {
        var _a, _b, _c;
        const element = document$2.getElementById((_a = this.mpEvent) === null || _a === void 0 ? void 0 : _a.target.id);
    ...
    get currentTarget() {
        var _a, _b, _c;
        const element = document$2.getElementById((_a = this.mpEvent) === null || _a === void 0 ? void 0 : _a.currentTarget.id);
        if (element === null) {
            return this.target;
        }
...
function eventHandler(event) {
    var _a;
    (_a = hooks$3.modifyMpEvent) === null || _a === void 0 ? void 0 : _a.call(hooks$3, event);
    ...
    if (node) {
        const dispatch = () => {
            ...
            (_a = hooks$3.modifyTaroEvent) === null || _a === void 0 ? void 0 : _a.call(hooks$3, e, node);
            node.dispatchEvent(e);
        };
        if (typeof hooks$3.batchedEventUpdates === 'function') {
            const type = event.type;
            if (!hooks$3.isBubbleEvents(type) ||
...
function injectPageInstance(inst, id) {
    var _a;
    (_a = hooks$1.mergePageInstance) === null || _a === void 0 ? void 0 : _a.call(hooks$1, instances.get(id), inst);
...
function createReactApp(App, react, dom, config) {
    ...
    let wrapper;
    if (!isBrowser) {
        wrapper = (_a = ReactDOM.render) === null || _a === void 0 ? void 0 : _a.call(ReactDOM, R.createElement(AppWrapper), document$1.getElementById('app'));
    }
        ...
        onLaunch: {
            ...
            value(options) {
                ...
                if (isBrowser) {
                    ...
                    wrapper = (_a = ReactDOM.render) === null || _a === void 0 ? void 0 : _a.call(ReactDOM, R.createElement(AppWrapper), document$1.getElementById((config === null || config === void 0 ? void 0 : config.appId) || 'app'));
                }
        ...
        onLaunch: {
            ...
            value(options) {
                ...
                if (isBrowser) {
                    ...
                    wrapper.$mount(document$1.getElementById((config === null || config === void 0 ? void 0 : config.appId) || 'app'));
                }
