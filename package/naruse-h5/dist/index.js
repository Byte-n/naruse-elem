...
var Image$1 = /** @class */ (function (_super) {
    ...
    Image.prototype.render = function () {
        ...
        return (h$6("div", { onClick: commonEventHander.bind(this), className: className, style: __assign(__assign({}, divStyle), style) }, h$6("img", __assign({ ref: function (img) { return (_this.imgRef = img); }, id: id, style: imgStyle, src: src, onLoad: this.imageOnLoad, onError: onError }, imgProps))));
    };
    return Image;
}(React.Component));
...
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.render = function () {
        ...
        return (h$5("input", { ref: function (input) {
...
var ScrollView = /** @class */ (function (_super) {
    ...
    ScrollView.prototype.render = function () {
        ...
        return (h$2("div", { className: "".concat(className, " _scrollView"), ref: function (container) {
                _this.container = container;
            }, style: __assign(__assign(__assign({}, cssStyle$1.scroll), style), scrollWhere), onScroll: _onScroll, onTouchMove: _onTouchMove }, this.props.children));
    };
    return ScrollView;
}(React.Component));
