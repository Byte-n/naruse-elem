...
class Button extends React.Component {
    ...
    render() {
        ...
        const conStyle = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, cssStyle$2['a-button']), (type ? cssStyle$2[type] : {})), style), (hover ? hoverStyle : {})), (active ? Object.assign(Object.assign({}, cssStyle$2.active), activeStyle) : {}));
        return (h("button", { onMouseEnter: this.onTouchStart.bind(this), onMouseLeave: this.onTouchEnd.bind(this), style: conStyle, disabled: disabled, className: className, onClick: commonEventHander.bind(this), onTouchStart: this.onTouchStart.bind(this), onTouchEnd: this.onTouchEnd.bind(this) }, this.props.children));
    }
}
...
class Checkbox extends React.Component {
    ...
    render() {
        ...
        return (h("input", Object.assign({ ref: dom => {
                if (!dom)
                    return;
                this.inputEl = dom;
                if (this.id)
...
class Image$1 extends React.Component {
    ...
    render() {
        const { className, src, style = {}, mode, onError, imgProps, } = this.props;
        const divStyle = Object.assign(Object.assign({}, cssStyle$1.naruseImg), (mode === 'widthFix' ? cssStyle$1.naruseImg__widthfix : {}));
        const imgStyle = cssStyle$1[(mode || 'scaleToFill').toLowerCase().replace(/\s/g, '')];
        return (h("div", { onClick: commonEventHander.bind(this), className: className, style: Object.assign(Object.assign({}, divStyle), style) }, h("img", Object.assign({ ref: img => (this.imgRef = img), style: imgStyle, src: src, onLoad: this.imageOnLoad, onError: onError }, imgProps))));
    }
}
...
class Text extends React.Component {
    ...
    render() {
        ...
        const cls = Object.assign(Object.assign(Object.assign(Object.assign({}, cssStyle.text), (selectable ? cssStyle.textSelectable : {})), style), (hover ? hoverStyle : {}));
        return (h$2("span", { id: id, onMouseEnter: this.onTouchStart.bind(this), onMouseLeave: this.onTouchEnd.bind(this), onTouchStart: this.onTouchStart.bind(this), onTouchEnd: this.onTouchEnd.bind(this), style: cls, className: className, onClick: commonEventHander.bind(this) }, this.props.children));
    }
}
