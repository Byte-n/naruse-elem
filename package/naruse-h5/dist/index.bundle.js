(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MyBundle = {}, global.React));
    ...
    ***************************************************************************** */
    ...
    if (React__default["default"].useState) {
        ...
        reactLikeHooksInit_1({
            ...
            getSelfComponent: function () {
                var _a, _b, _c;
                // @ts-ignore
                return (_c = (_b = (_a = React__default["default"] === null || React__default["default"] === void 0 ? void 0 : React__default["default"].__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _a === void 0 ? void 0 : _a.ReactCurrentOwner) === null || _b === void 0 ? void 0 : _b.current) === null || _c === void 0 ? void 0 : _c._instance;
            },
    ...
    var naruseCreateElement = function (type, props) {
        ...
        if (typeof type === 'string') {
            ...
            return React__default["default"].createElement.apply(void 0, __spreadArray$1([Component_1, props], children, false));
        }
        if (type.prototype instanceof React__default["default"].Component) {
            return React__default["default"].createElement.apply(void 0, __spreadArray$1([type, props], children, false));
        }
        if (typeof type === 'function') {
            ...
            return React__default["default"].createElement(functionalizae(type), props);
        }
        logger.warn('不支持的组件类型', type);
    };
    ...
    ***************************************************************************** */
    ...
    })(exports.LoggerLanding || (exports.LoggerLanding = {}));
    ...
    var levels = [exports.LoggerLevel.debug, exports.LoggerLevel.info, exports.LoggerLevel.warn, exports.LoggerLevel.error, exports.LoggerLevel.none];
    /** 获取空广告 */
    ...
    var LoggerPlus = /** @class */ (function () {
        ...
        function LoggerPlus(_a, publicInfo) {
            ...
            // 当前日志等级
            this._curLoggerLevel = exports.LoggerLevel.debug;
        ...
        LoggerPlus.prototype.clone = function (info, ignoredNull) {
            ...
            {
                adData: nullAdData(),
                landing: exports.LoggerLanding.production,
                adVer: adVer
            }, {
                appName: obj.appName,
                landing: obj.landing,
        ...
        LoggerPlus.prototype.debug = function (event) {
            ...
            this._request.apply(this, __spreadArray$1([exports.LoggerLevel.debug, event], args, false));
        };
        /** info 日志 */
        LoggerPlus.prototype.info = function (event) {
            ...
            this._request.apply(this, __spreadArray$1([exports.LoggerLevel.info, event], args, false));
        };
        /** warn 日志 */
        LoggerPlus.prototype.warn = function (event) {
            ...
            this._request.apply(this, __spreadArray$1([exports.LoggerLevel.warn, event], args, false));
        };
        /** error 日志 */
        LoggerPlus.prototype.error = function (event) {
            ...
            this._request.apply(this, __spreadArray$1([exports.LoggerLevel.error, event], args, false));
        };
        /** 是否可打印 level 级别的日志 */
    ...
    var LoggerPlugin = /** @class */ (function (_super) {
        ...
        LoggerPlugin.prototype.onError = function (_a) {
            ...
            // 打印错误日志
            $logger.clone({ landing: exports.LoggerLanding[source] })
    ...
    var Naruse = __assign(__assign(__assign({}, api), getHooks()), { Component: React__default["default"].Component, createElement: naruseCreateElement, env: {
            ...
            language: 'zh-Hans',
            platform: 'H5',
        }, getDeferred: getDeferred, globalEvent: globalEvent, EventBus: EventBus, version: version, unsafe_run: run, runCodeWithNaruse: runCodeWithNaruse, withPage: withPage, cloneElement: React__default["default"].cloneElement, isValidElement: React__default["default"].isValidElement, Children: React__default["default"].Children });
    ...
    exports.LoggerPlus = LoggerPlus;
    exports.Naruse = Naruse;
    exports.Plugin = Plugin;
    exports["default"] = Container;
    exports.naruseExtend = naruseExtend;
    exports.naruseInit = naruseInit;
