...
var isObj = function (obj) { return obj !== null && typeof obj === 'object'; };
/**
 ...
 * @param {*} [config={}]
 */
var processApis = function processApis(Naruse, global, config) {
    if (config === void 0) { config = {}; }
    if (!global)
        return;
    var apis = config.needPromiseApis || [];
    var syncApis = config.needSyncApis || [];
    var transformMeta = config.transformMeta;
    // 处理所有需要promisify的api
    apis.forEach(function (key) {
        var originKey = key;
        Naruse[originKey] = function (options) {
            ...
            if (typeof options === 'string') {
                if (args.length) {
                    return global[key].apply(global, __spreadArray$1([options], args, false));
                }
                return global[key](options);
            }
            // 改变 key 或 option 字段
            if (config.transformMeta) {
                var _a = transformMeta(key, options), newKey = _a.key, newOpt = _a.options;
                key = newKey;
                options = newOpt;
                // 新 key 可能不存在
...
var NaruseComponent = /** @class */ (function () {
    ...
    NaruseComponent.$isNaruseClass = true;
...
var VirtualPage = /** @class */ (function () {
     ...
     * @param {*} value
     */
    VirtualPage.prototype.interceptEvent = function (key) {
        var _this = this;
        var selfPage = this;
        // 保存原有事件并进入事件中心
    ...
    VirtualPage.prototype.on = function (eventName, func) {
    ...
    VirtualPage.prototype.off = function (eventName, func) {
        this.eventCenter.off(eventName, func);
    };
    VirtualPage.prototype.once = function (eventName, func) {
        this.eventCenter.once(eventName, func);
    };
    Object.defineProperty(VirtualPage.prototype, "route", {
        get: function () {
    ...
    VirtualPage.prototype.clear = function () {
        var _this = this;
...
var getNaruseComponentFromCode = function (code, ctx) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        executeCode = function (code) { return run(code, context, onError.bind(null, RunningCodeErrorSource.errorCenter)); };
...
var createMainBehavior = function (option) {
    ...
    // 小程序组件默认minxs对象
    var naruseBehavior = __assign(__assign({}, getMiniappEventBehavior()), { __NaruseUniqueComponentPageShowEvent: null, 
        /**
         * @description 装载完毕后
         * @author CHC
        ...
        didMount: function () {
            ...
            if (this.isNaruseMainComponent) {
                ...
                if (unique) {
                    ...
                    this.__NaruseUniqueComponentPageShowEvent = function (event) {
                        // 小程序对象Page.__proto__.route
                        var path = Object.getPrototypeOf(_this.$page).route;
                        globalEvent.emit('__NaruseUniqueComponentPageShow', { path: path, event: event || 'onShow' });
                    };
